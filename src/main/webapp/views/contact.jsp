...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <c:if test="${not empty user.userID}">
					<ul class="navbar-nav ml-auto mb-2 mb-lg-0">
						<li class="nav-item"><a class="nav-link nav-link-1"
							aria-current="page" href="/AssignmentJava4/Home">Home</a></li>
						<li class="nav-item"><a class="nav-link nav-link-2"
							href="/AssignmentJava4/Favourite">My Favorites</a></li>
					...
					<div class="nav-item dropdown">
						...
						<div class="dropdown-menu"
							...
							<a class="dropdown-item" href="/AssignmentJava4/logout">Logout</a> <a
								class="dropdown-item" href="changePassword">Change password</a> <a
								class="dropdown-item" href="/AssignmentJava4/views/editFrofile.jsp">Edit frofile</a>
						</div>
					</div>
				</c:if>
				<c:if test="${empty user.userID}">
					...
					<div class="nav-item dropdown">
						...
						<div class="dropdown-menu"
							aria-labelledby="navbarDropdownMenuLink">
							<a class="dropdown-item" href="/AssignmentJava4/register">Register</a> <a
								class="dropdown-item" href="/AssignmentJava4/login">Login</a>
						</div>
					</div>
				</c:if>
            </div>
    ...
    <div class="tm-hero d-flex justify-content-center align-items-center" data-parallax="scroll"
        data-image-src="img/banner4.jpg" style="width: 100%; height: 400px;"></div>
                ...
                <div class="mapouter mb-4">
                    <div class="gmap-canvas">
                        <iframe width="100%" height="520" id="gmap-canvas"
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3833.9763117865696!2d108.18471621477794!3d16.066718988882496!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31421901da0acdbf%3A0x6fea898ba4d1ac8d!2zR2FsYXh5IMSQw6AgTuG6tW5n!5e0!3m2!1svi!2s!4v1678352697982!5m2!1svi!2s"
        ...
        <div class="container-fluid tm-container-small">
            <div class="row">
                <div class="col-lg-6 col-md-12 col-12 px-5 mb-5">
                    <h3 class="tm-text-primary mb-4 tm-footer-title">About CINEMA-V</h3>
                    <p>CINEMA-V is free Bootstrap 5 Alpha 2 HTML Template for video and photo websites. You can freely
            ...
            <div class="row">
                <div class="col-lg-8 col-md-7 col-12 px-5 mb-3">
                    Copyright 2020 CINEMA-V Company. All rights reserved.
                </div>
