...
<div class="tm-hero d-flex justify-content-center align-items-center"
	...
	data-image-src="/AssignmentJava4/views/img/poster-phim.png"
...
<div class="container-fluid tm-container-content tm-mt-60">
	<div class="row mb-4">
		<h2 class="col-6 tm-text-primary">My Favorite Videos</h2>
	</div>
			...
			<c:forEach var="item" items="${videos }">
				<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
					<figure class="effect-ming tm-video-item">
						<img alt="" src="/AssignmentJava4/uploads/${item.poster}"
	...
	<c:if test="${empty videos }">
		<div class="row text-center justify-content-center my-5">
			<h6>
				<i>Danh sách video ưu thích của bạn chưa có video nào!!</i>
			</h6>
		</div>
	</c:if>
	<!-- row -->
	...
	<div class="container-fluid tm-container-small">
		<div class="row">
			<div class="col-lg-6 col-md-12 col-12 px-5 mb-5">
				<h3 class="tm-text-primary mb-4">About CINEMA-V</h3>
