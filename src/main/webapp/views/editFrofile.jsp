<%@page import="edu.poly.entity.User"%>
...
<link rel="stylesheet"
	href="/AssignmentJava4/views/css/bootstrap.min.css">
<link rel="stylesheet"
	href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">
<link rel="stylesheet"
	href="/AssignmentJava4/views/css/templatemo-style.css">
<link rel="stylesheet"
...
<body>
	...
	<nav class="navbar navbar-expand-lg">
		<div class="container-fluid">
			<a class="navbar-brand" href="index.html"> <i
				class="fas fa-film mr-2"></i> CINEMA-V
			</a>
					...
					<div class="nav-item dropdown">
						...
						<div class="dropdown-menu"
							...
							<a class="dropdown-item"
								href="/AssignmentJava4/views/editFrofile.jsp">Edit frofile</a>
						</div>
					</div>
				</c:if>
	...
	<div class="tm-hero d-flex justify-content-center align-items-center"
		data-parallax="scroll" data-image-src="/AssignmentJava4/views/img/poster-phim.png"
		style="width: 100%; height: 500px;"></div>
	<div class="container-fluid" style="background-color: #CCCC99;">

		<div class="container py-5">
			<div class="mb-3">
				<!-- Button trigger modal -->
				<button type="button" class="btn btn-primary" data-toggle="modal"
					data-target="#exampleModalCenter">CẬP NHẬT THÔNG TIN</button>
						...
						<div class="modal-dialog modal-dialog-centered" role="document">
							<div class="modal-content">
								<div class="modal-header">
									<h5 class="modal-title" id="exampleModalLongTitle">Cập
										nhật thông tin</h5>
								...
								<div class="modal-footer">
									...
									<button type="submit" class="btn btn-success"
										style="height: 40px;" formaction="/AssignmentJava4/changeInfo">Save
										changes</button>
								</div>
							</div>
						</div>
				...
				<div class="col-lg-4">
					<div class="card mb-4">
						<div class="card-body text-center">
							<img
								src="https://antimatter.vn/wp-content/uploads/2022/05/hinh-anh-gai-xinh-cap-2-3.jpg"
