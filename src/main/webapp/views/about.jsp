...
<body>
				...
				<c:if test="${not empty user.userID}">
					<ul class="navbar-nav ml-auto mb-2 mb-lg-0">
						...
						<li class="nav-item"><a class="nav-link nav-link-3"
							href="/AssignmentJava4/views/about.jsp active">About</a></li>
	...
	<div class="container-fluid tm-mt-60">
		<div class="row mb-4">
			<h2 class="col-12 tm-text-primary">About CINEMA-V Website
				Template</h2>
		</div>
		<div class="row tm-mb-74 tm-row-1640">
			<div class="col-lg-5 col-md-6 col-12 mb-3">
				<img src="img/cinema1.jpg" alt="Image" class="img-fluid">
			</div>
