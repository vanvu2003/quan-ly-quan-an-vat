<%@ page language="java" pageEncoding="utf-8" %>
	<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
		...
		<head>
			...
			<title>CINEMA-V Video Detail Page</title>
		...
		<body>
			...
			<nav class="navbar navbar-expand-lg">
				<div class="container-fluid">
					<a class="navbar-brand" href="/AssignmentJava4/Home"> <i class="fas fa-film mr-2"></i> CINEMA-V
					</a>
						...
						<c:if test="${not empty user.userID}">
							...
							<div class="nav-item dropdown">
								...
								<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
									...
									<a class="dropdown-item" href="#">Logout</a> <a class="dropdown-item"
			...
			<div class="tm-hero d-flex justify-content-center align-items-center" data-parallax="scroll"
				data-image-src="/AssignmentJava4/views/img/banner2.jpg" style="width: 100%; height: 400px;"></div>

			<div class="container-fluid tm-container-content tm-mt-60">
				<div class="row mb-4">
					<h2 class="col-12 tm-text-primary">${video.tiltle}</h2>
				</div>
				<div class="row tm-mb-90">
					<div class="col-xl-8 col-lg-7 col-md-6 col-sm-12">
						<video autoplay muted loop controls id="tm-video">
							<source src="/AssignmentJava4/uploads/${video.link }" type="video/mp4">
						</video>
					</div>
					<div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
						<div class="tm-bg-gray tm-video-details">
							...
							<div class="row">
								<form action="/AssignmentJava4/likeVideo" method="post">
									<c:choose>
										<c:when test="${empty sessionScope.user }">
											<button class="btn btn-primary mb-5 text-center" name="like" id="like-btn"
												onclick="checkLogin()" type="button">
												<i class="bi bi-hand-thumbs-up"></i> &nbsp;Like
											</button>
											<button class="btn btn-primary mb-5 text-center ml-2" id="like-btn"
										...
										<c:otherwise>
											<c:if test="${not empty vdFavourite }">
												<button class="btn btn-primary mb-5 text-center" name="like"
													id="like-btn" onclick="toggleLike()" type="button">
													<i class="bi bi-hand-thumbs-up"></i> &nbsp;Đã like
												</button>
											</c:if>
											<c:if test="${empty vdFavourite }">
												<button class="btn btn-primary mb-5 text-center" name="like"
													id="like-btn" onclick="toggleLike()" type="button">
													<i class="bi bi-hand-thumbs-up"></i> &nbsp;Like
												</button>
												...
												<div class="modal-dialog modal-dialog-centered" role="document">
													<div class="modal-content">
														<div class="modal-header">
															<h5 class="modal-title" id="exampleModalLongTitle">Share
																Video</h5>
														...
														<div class="modal-body">
															<form action="">
																<input type="email" placeholder="Nhập vào email"
																	id="emailShare" class="form-control" required>
															</form>
														</div>
														<div class="modal-footer">
															<button type="button" class="btn btn-secondary"
																data-dismiss="modal">Close</button>
															<button type="button" id="myButton" onclick="shareVideo()"
							...
							<div class="mb-4 d-flex flex-wrap">
								...
								<div>
									<span class="tm-text-gray-dark">View: </span><span
										class="tm-text-primary">${video.views } lượt xem</span>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="row mb-3 tm-gallery">
					<c:forEach var="item" items="${suggestedVideo }">
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
							<figure class="effect-ming tm-video-item">
								<img alt="" src="/AssignmentJava4/uploads/${item.poster}" height="200px" width="100%">
								<figcaption class="d-flex align-items-center justify-content-center">
									<h2>See more</h2>
									<a href="/AssignmentJava4/VideoDetail?id=${item.idVideo}">View
										more</a>
								</figcaption>
							</figure>
							<div class="d-flex justify-content-between tm-text-gray">
								<span class="tm-text-gray-light">${item.tiltle }</span> <span>${item.views }
									lượt xem</span>
							</div>
						</div>
					</c:forEach>
			...
			<script>
				...
				function toggleLike() {
					...
					if (liked) {
						liked = false;
						document.getElementById("like-btn").innerHTML = '<i class="bi bi-hand-thumbs-up"></i>&nbsp;Like';
					} else {
						liked = true;
						document.getElementById("like-btn").innerHTML = '<i class="bi bi-hand-thumbs-up"></i>&nbsp;Đã like';
					}

					$.post('/AssignmentJava4/likeVideo', {
						like: liked
					}, function (data) {
				...
				function showLoading() {
					document.getElementById("myButton").innerHTML = "Vui lòng chờ...";
				}
				function shareVideo() {
					showLoading();
					$.ajax({
						url: "/AssignmentJava4/shareVideo",
						type: "POST",
