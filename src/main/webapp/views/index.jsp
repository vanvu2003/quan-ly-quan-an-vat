...
-->
		...
		<body>
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<c:if test="${not empty user.userID}">
							<ul class="navbar-nav ml-auto mb-2 mb-lg-0">
								<li class="nav-item"><a class="nav-link nav-link-1 active" aria-current="page"
			...
			<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img class="d-block w-100" src="/AssignmentJava4/views/img/banner1.jpg" alt="First slide"
							style="width: 100%; height: 400px;">
					</div>
					<div class="carousel-item">
						<img class="d-block w-100" src="/AssignmentJava4/views/img/banner2.jpg" alt="Second slide"
							style="width: 100%; height: 400px;">
					</div>
					<div class="carousel-item">
						<img class="d-block w-100" src="/AssignmentJava4/views/img/banner3.png" alt="Third slide"
							style="width: 100%; height: 400px;">
					</div>
				</div>
			...
			<div class="container-fluid tm-container-content tm-mt-60">
				<div class="row mb-4">
					<h2 class="col-6 tm-text-primary">DANH SÁCH VIDEO</h2>
				</div>
					...
					<c:forEach var="item" items="${listVideo }">
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
							...
							<div class="d-flex justify-content-between tm-text-gray">
								<span class="tm-text-gray-dark">${item.tiltle }</span> <span>${item.views }
									lượt xem</span>
							</div>
						</div>
					</c:forEach>
				...
				<!-- row -->
				<div class="row tm-mb-90 text-center justify-content-sm-center">
					<div class="col-12 d-flex justify-content-between align-items-center tm-paging-col">
						<div class="tm-paging d-flex">
							<c:forEach var="item" begin="1" end="${pagecount }" step="1">
								<a href="/AssignmentJava4/Home?index=${item}"
									class="tm-paging-link ${index == item?'active':''}">${item}</a>
							</c:forEach>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-lg-6 col-md-12 col-12 px-5 mb-5">
							<h3 class="tm-text-primary mb-4 tm-footer-title">About
								CINEMA-V</h3>
							<p>
								CINEMA-V is free <a rel="sponsored" href="https://v5.getbootstrap.com/">Bootstrap 5</a>
								Alpha 2 HTML
